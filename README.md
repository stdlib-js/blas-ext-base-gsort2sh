...
```javascript
gsort2sh = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsort2sh@v0.2.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-gsort2sh/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/blas-ext-base-gsort2sh/actions/workflows/test.yml?query=branch:v0.2.0
